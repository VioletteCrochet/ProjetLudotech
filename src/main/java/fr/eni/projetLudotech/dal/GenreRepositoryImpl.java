...
public class GenreRepositoryImpl implements GenreRepository {
    ...
    public Optional<Genre> findGenreById(Integer id) {
        ...
        try {
            Genre genre = namedParameterJdbcTemplate.queryForObject(sql, params, new BeanPropertyRowMapper<>(Genre.class));
    ...
    // Classe interne GenreRowMapper pour mapper les résultats de la base de données à des objets Genre
